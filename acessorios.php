...
<body>
    ...
    <main class="container mt-4">
        <div class="p-5 rounded">
            ...
            <h1 class="h4 font-weight-bold mb-2">Acessórios: Descubra os melhores preços</h1>
            <p class="text-muted mb-4">Explore ritmos envolventes com as nossos produtos de altíssima qualidade.</p>

            <div class="row">
                <div class="col-md-3 mb-4">
                    <div class="card ">
                        <img alt="Bateria Acústica Completa" class="card-img-top" src="imagens/acessorio.png">
