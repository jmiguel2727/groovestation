            ...
            <div class="row">
                ...
                <div class="col-md-4 col-lg-3 mb-4">
                    <div class="card ">
                        ...
                        <div class="card-body text-center">
                            <p class="card-text">Casio CT-S100 Preto</p>
                ...
                <div class="col-md-4 col-lg-3 mb-4">
                    <div class="card ">
                        ...
                        <div class="card-body text-center">
                            <p class="card-text">Casio CT-S1</p>
                ...
                <div class="col-md-4 col-lg-3 mb-4">
                    <div class="card ">
                        ...
                        <div class="card-body text-center">
                            <p class="card-text">MIDI 25 teclas</p>
                ...
                <div class="col-md-4 col-lg-3 mb-4">
                    <div class="card ">
                        ...
                        <div class="card-body text-center">
                            <p class="card-text">MIDI 49 Teclas</p>
                ...
                <div class="col-md-4 col-lg-3 mb-4">
                    <div class="card ">
                        ...
                        <div class="card-body text-center">
                            <p class="card-text">MIDI 88 Teclas</p>
